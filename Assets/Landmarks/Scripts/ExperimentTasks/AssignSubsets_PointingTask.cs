...
public class AssignSubsets_PointingTask : ExperimentTask
{
    ...
    public MoveSpawn_Updated moveSpawnReference;
    ...
    public override void startTask()
    {
        ...
        // Assign the ObjectList components of these game objects to the Pointing Task script
        pointingTaskReference.listOfLocations = subset0.GetComponent<ObjectList>();
        pointingTaskReference.listofTargets = subset1.GetComponent<ObjectList>();
        ...
        // Assign the ObjectList components of these game objects to the MoveSpawn_Updated script
        moveSpawnReference.destinations = subset0.GetComponent<ObjectList>();
